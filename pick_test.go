...
func TestPick(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			var actual = slicekit.Pick(values, test.offset, test.limit)
...
func TestPickWithEmptySlice(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			var actual = slicekit.Pick(emptySlice, test.offset, test.limit)
			if !slicekit.Equals(actual, test.expected, IntEqual) {
				t.Fatalf("实际: %+v, 预期: %+v", actual, test.expected)
			}
		})
...
func TestPickWithNilSlice(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			var actual = slicekit.Pick(nilSlice, test.offset, test.limit)
			if !slicekit.Equals(actual, test.expected, IntEqual) {
				t.Fatalf("实际: %+v, 预期: %+v", actual, test.expected)
			}
		})
...
func TestPickWithSingleElement(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			var actual = slicekit.Pick(singleSlice, test.offset, test.limit)
			if !slicekit.Equals(actual, test.expected, IntEqual) {
				t.Fatalf("实际: %+v, 预期: %+v", actual, test.expected)
			}
		})
