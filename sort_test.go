...
func TestSortStringSlice(t *testing.T) {
	...
	slicekit.Sort(strs, cmpStringAsc)
...
func TestSortStringSliceDesc(t *testing.T) {
	strs := []string{"foo", "bar", "baz", "abc"}
	slicekit.Sort(strs, cmpStringDesc)
...
func TestSortTime(t *testing.T) {
	...
	start := time.Now()
	slicekit.Sort(people, func(a, b Person) int { return a.Age - b.Age },
		func(a, b Person) int {
			if a.Score < b.Score {
				return 1
